...
import { ILifestyleController, ILifestyleService } from "../../interfaces/ILifestyle";
...
class LifestyleController implements ILifestyleController {
    ...
    getLifestyle = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            const { id } = req.params;
    ...
    updateLifestyle = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            const { id } = req.params;
            ...
            const lifestyle = await this.lifestyleService.updateLifestyle(id, updateData);

...
const MyAccount = () => {
  const [currentState, setCurrentState] =
    useState<CurrentState>("view-account");
  ...
  return (
    <>
      {currentState === "view-account" && (
        <Profile
          handleEditProfile={switchToEditProfile}
          handleEditAddress={swithToEditAddress}
        />
      )}
      {currentState === "edit-profile" && (
        <EditProfile handleSave={switchToViewProfile} />
      )}
      {currentState === "edit-address" && (
        <EditAddress handleSave={switchToViewProfile} />
      )}
    </>
  );
};

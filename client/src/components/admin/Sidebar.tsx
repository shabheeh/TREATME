...
const menuItems = [
  ...
  { text: 'Doctors', icon: <Message />, path: '/admin/doctors' },
  { text: 'Messages', icon: <CalendarMonth />, path: '/admin/messages' },
  { text: 'Specialties', icon: <MedicalServices />, path: '/admin/spcialties' },
  { text: 'Recruitements', icon: <PersonSearch />, path: '/admin/spcialties' },
];

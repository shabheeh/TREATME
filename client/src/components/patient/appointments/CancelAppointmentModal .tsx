    ...
    >
      <Box sx={{
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
          <Typography id="cancel-appointment-title" variant="h6" component="h2" color="error">
            Cancel Appointment
          </Typography>
          <Button 
            onClick={ () => onClose()}
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          Please note that cancellations made less than 24 hours before your scheduled appointment may be subject to a cancellation fee of 50rs.
        </Alert>

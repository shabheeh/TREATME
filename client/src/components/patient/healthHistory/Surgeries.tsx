...
const Surgeries: React.FC<SurgeriesProps> = ({ surgeries, onUpdate }) => {
  const [showSurgeryInputs, setShowSurgeryInputs] = useState(
    surgeries.length > 0
  );
    ...
    >
      ...
      {surgeries.length === 0 && (
        <Stack direction="row" spacing={2}>
          <Button
            ...
            startIcon={
              showSurgeryInputs ? <CheckCircle /> : <RadioButtonUnchecked />
            }
          ...
          <Button
            ...
            startIcon={
              showSurgeryInputs ? <RadioButtonUnchecked /> : <CheckCircle />
            }
      ...
      {showSurgeryInputs && (
        <Box sx={{ width: "100%", my: 2 }}>
          ...
          {surgeries.length > 0 && (
            <Typography sx={{ fontWeight: 600 }}>Add new Prodedure</Typography>
          )}

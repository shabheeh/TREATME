...
const HealthConditions: React.FC<HealthConditionsProps> = ({
  ...
  const [conditionToRemove, setConditionToRemove] =
    useState<IHealthCondition | null>(null);
      ...
      {healthConditions.length === 0 && (
        <Stack direction="row" spacing={2}>
          <Button
            ...
            startIcon={
              showConditionInputs ? <CheckCircle /> : <RadioButtonUnchecked />
            }
          ...
          <Button
            ...
            startIcon={
              showConditionInputs ? <RadioButtonUnchecked /> : <CheckCircle />
            }
